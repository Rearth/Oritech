...
- **[Fragment Forge](@oritech:fragment_forge)**: Doubles the amount
of byproducts produced during ore processing. Only one yield addon can be used here.
- **[Block Destroyer](@oritech:destroyer)** and
**[Enderic Laser](@oritech:enderic_laser)**: Increases the resource yield
