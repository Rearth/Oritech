...
[Refinery Chamber Modules](@oritech:refinery_chamber_module) on top of the 
main block. 
...
<Callout variant="info">
    The refinery has no addon slots and cannot directly be upgraded / sped up. However, check out the [tainted refinery](@oritech:tainted_refinery)
