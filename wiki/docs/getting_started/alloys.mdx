...
Hand crafting is acceptable for the very first machines. As soon as possible, though, move alloy production into a [Pulverizer](@oritech:pulverizer) plus [Foundry](@oritech:foundry) setup.
