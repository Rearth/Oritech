...
public class PortableTankEntity extends NetworkedBlockEntity implements FluidProvider, ItemProvider, ComparatorOutputProvider,
    ...
    public PortableTankEntity(BlockPos pos, BlockState state, boolean isCreative) {
        super((isCreative ? BlockEntitiesContent.CREATIVE_TANK : BlockEntitiesContent.PORTABLE_TANK).get(), pos, state);
