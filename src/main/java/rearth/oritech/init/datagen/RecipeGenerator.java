...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    private void addMachines(RecipeExporter exporter) {
        ...
        offerGeneratorRecipe(exporter, BlockContent.MACHINE_HUNTER_ADDON.asItem(), Ingredient.fromTag(TagContent.MACHINE_PLATING), Ingredient.ofItems(ItemContent.MOTOR), Ingredient.ofItems(Items.MAGMA_BLOCK), Ingredient.ofItems(ItemContent.PLASTIC_SHEET), "_hunter");
