...
import rearth.oritech.block.fluid.OritechFluidType;
import rearth.oritech.block.fluid.RisingFluid;
import rearth.oritech.block.fluid.SheolFireFluidType;
import rearth.oritech.block.fluid.SheolFireFluidBlock;
import rearth.oritech.block.fluid.StrangeMatterFluidBlock;
import rearth.oritech.block.fluid.SteamFluidType;
...
public class FluidContent {
    ...
    public static final DeferredHolder<FluidType, FluidType> OIL_TYPE = FLUID_TYPES.register("oil_fluid_type", () -> waterLikeFluid(1050, 315, 1800, 0.75));
    ...
    public static final DeferredHolder<FluidType, FluidType> FUEL_TYPE = FLUID_TYPES.register("fuel_fluid_type", () -> waterLikeFluid(780, 300, 850, 0.95));
    ...
    public static final DeferredHolder<FluidType, FluidType> BIOFUEL_TYPE = FLUID_TYPES.register("biofuel_fluid_type", () -> waterLikeFluid(830, 300, 950, 0.9));
    ...
    public static final DeferredHolder<FluidType, FluidType> STEAM_TYPE = FLUID_TYPES.register("steam_fluid_type", () -> new SteamFluidType(FluidType.Properties.create().motionScale(0.02D).canPushEntity(true).canSwim(false).canDrown(false).fallDistanceModifier(0.0F).density(-500).temperature(450).viscosity(100)));
    public static final DeferredHolder<Fluid, RisingFluid.Flowing> FLOWING_STEAM = FLUIDS.register("flowing_steam", () -> new RisingFluid.Flowing(new BaseFlowingFluid.Properties(STEAM_TYPE, FluidContent.STILL_STEAM, FluidContent.FLOWING_STEAM).block(FluidContent.STILL_STEAM_BLOCK).bucket(FluidContent.STILL_STEAM_BUCKET).tickRate(3)));
    public static final DeferredHolder<Fluid, RisingFluid.Source> STILL_STEAM = FLUIDS.register("still_steam", () -> new RisingFluid.Source(new BaseFlowingFluid.Properties(STEAM_TYPE, FluidContent.STILL_STEAM, FluidContent.FLOWING_STEAM).block(FluidContent.STILL_STEAM_BLOCK).bucket(FluidContent.STILL_STEAM_BUCKET).tickRate(3)));
    ...
    public static final DeferredHolder<FluidType, FluidType> HEAVY_OIL_TYPE = FLUID_TYPES.register("heavy_oil_fluid_type", () -> waterLikeFluid(1250, 330, 2400, 0.55));
    ...
    public static final DeferredHolder<FluidType, FluidType> DIESEL_TYPE = FLUID_TYPES.register("diesel_fluid_type", () -> waterLikeFluid(830, 340, 1000, 0.9));
    ...
    public static final DeferredHolder<FluidType, FluidType> NAPHTHA_TYPE = FLUID_TYPES.register("naphtha_fluid_type", () -> waterLikeFluid(720, 335, 550, 1.05));
    ...
    public static final DeferredHolder<FluidType, FluidType> SULFURIC_ACID_TYPE = FLUID_TYPES.register("sulfuric_acid_fluid_type", () -> new OritechFluidType(FluidType.Properties.create().motionScale(0.01).density(1800).temperature(320).viscosity(1400).rarity(Rarity.UNCOMMON), 0.7));
    ...
    public static final DeferredHolder<FluidType, FluidType> SILICON_WASH_TYPE = FLUID_TYPES.register("silicon_wash_fluid_type", () -> waterLikeFluid(1080, 300, 1100, 0.85));
    ...
    public static final DeferredHolder<FluidType, FluidType> MINERAL_SLURRY_TYPE = FLUID_TYPES.register("mineral_slurry_fluid_type", () -> waterLikeFluid(1600, 295, 2600, 0.5));
    ...
    public static final DeferredHolder<FluidType, FluidType> SHEOL_FIRE_TYPE = FLUID_TYPES.register("sheol_fire_fluid_type", () -> new SheolFireFluidType(FluidType.Properties.create().motionScale(0.003).canSwim(false).canDrown(false).canPushEntity(true).fallDistanceModifier(0.1F).lightLevel(15).density(850).temperature(1400).viscosity(900).rarity(Rarity.RARE)));
    ...
    public static final DeferredHolder<FluidType, FluidType> STRANGE_MATTER_TYPE = FLUID_TYPES.register("strange_matter_fluid_type", () -> new OritechFluidType(FluidType.Properties.create().canDrown(false).canPushEntity(false).lightLevel(7).density(1800).temperature(500).viscosity(1800).rarity(Rarity.EPIC), 1.0));
    ...
    public static final DeferredHolder<Block, StrangeMatterFluidBlock> STILL_STRANGE_MATTER_BLOCK = FLUID_BLOCKS.registerBlock("still_strange_matter_block", props -> new StrangeMatterFluidBlock(STILL_STRANGE_MATTER.get(), props), () -> BlockBehaviour.Properties.ofFullCopy(Blocks.WATER));
    ...
    private static FluidType waterLikeFluid(int density, int temperature, int viscosity, double movementScale) {
        return new OritechFluidType(
            FluidType.Properties.create()
                .motionScale(0.014 * movementScale)
                .density(density)
