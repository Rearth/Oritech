...
public class ModScreens implements AutoRegistryContainer<ScreenHandlerType<?>> {
    ...
    public static final ExtendedScreenHandlerType<BasicMachineScreenHandler> ASSEMBLER_SCREEN = new ExtendedScreenHandlerType<>(BasicMachineScreenHandler::new);
    ...
    public static void assignScreens() {
        ...
        HandledScreens.register(ASSEMBLER_SCREEN, BasicMachineScreen::new);
            }
