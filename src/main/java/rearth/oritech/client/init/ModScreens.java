...
public class ModScreens {
    ...
    public static final Supplier<MenuType<OritechScreenHandler>> TREE_CUTTER_SCREEN = MENUS.register("tree_cutter_screen", () -> IMenuTypeExtension.create(OritechScreenHandler::new));
    ...
    public static final Supplier<MenuType<UpgradableOritechScreenHandler>> ENERGY_TRANSMISSION_POLE_SCREEN = MENUS.register("energy_transmission_pole_screen", () -> IMenuTypeExtension.create(UpgradableOritechScreenHandler::new));
    public static final Supplier<MenuType<UpgradableOritechScreenHandler>> SCHRODINGERS_SAFE_SCREEN = MENUS.register("schrodingers_safe_screen", () -> IMenuTypeExtension.create(UpgradableOritechScreenHandler::new));
    ...
    public static final Supplier<MenuType<UpgradableOritechScreenHandler>> ADDON_SPLICER_SCREEN = MENUS.register("addon_splicer_screen", () -> IMenuTypeExtension.create(UpgradableOritechScreenHandler::new));
    ...
    public static final Supplier<MenuType<StabilizedEnchanterScreenHandler>> STABILIZED_ENCHANTER_SCREEN = MENUS.register("stabilized_enchanter_screen", () -> IMenuTypeExtension.create(StabilizedEnchanterScreenHandler::new));
    ...
    public static final Supplier<MenuType<CyberneticAugmentationCenterScreenHandler>> MODIFIER_SCREEN = MENUS.register("modifier_screen", () -> IMenuTypeExtension.create(CyberneticAugmentationCenterScreenHandler::new));
    ...
    public static void registerScreens(RegisterMenuScreensEvent event) {
        ...
        event.<OritechScreenHandler, OritechMachineScreen<OritechScreenHandler>>register(TREE_CUTTER_SCREEN.get(), OritechMachineScreen::new);
        ...
        event.register(STABILIZED_ENCHANTER_SCREEN.get(), StabilizedEnchanterScreen::new);
        event.register(ACCELERATOR_SCREEN.get(), AcceleratorScreen::new);
        event.<OritechScreenHandler, OritechMachineScreen<OritechScreenHandler>>register(EQUIPMENT_CHARGER_SCREEN.get(), OritechMachineScreen::new);
        ...
        event.register(ENERGY_TRANSMISSION_POLE_SCREEN.get(), EnergyTransmissionPoleScreen::new);
        event.register(SCHRODINGERS_SAFE_SCREEN.get(), SchrodingersSafeScreen::new);
        ...
        event.register(ADDON_SPLICER_SCREEN.get(), AddonSplicerScreen::new);

        event.register(INVENTORY_PROXY_SCREEN.get(), InventoryProxyScreen::new);
        event.register(REACTOR_SCREEN.get(), ReactorScreen::new);
        event.register(MODIFIER_SCREEN.get(), CyberneticAugmentationCenterScreen::new);
