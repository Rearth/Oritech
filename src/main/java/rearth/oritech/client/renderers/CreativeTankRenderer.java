...
public class CreativeTankRenderer implements BlockEntityRenderer<CreativeFluidTankEntity> {
    
    @Override
    public void render(CreativeFluidTankEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
