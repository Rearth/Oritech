...
public class EndericLaserRenderer<R extends BlockEntityRenderState & GeoRenderState> extends ModelBoundedGeoBlockRenderer<EndericLaserBlockEntity, R> {
    ...
    public AABB getRenderBoundingBox(EndericLaserBlockEntity blockEntity) {
        return AABB.INFINITE;
    }

    private Vec3 getOffsetByDrillId(long id, EndericLaserBlockEntity laserEntity) {
    ...
    private Vec3 getIdleTarget(EndericLaserBlockEntity entity) {
    ...
    @Override
    public void addRenderData(EndericLaserBlockEntity laserEntity, @Nullable Void relatedObject, R renderState, float partialTick) {
        ...
        if (target != null && !target.equals(Vec3.ZERO)) {
            ...
            laserEntity.lastLaserRotX = EndericLaserModel.lerp(laserEntity.lastLaserRotX, (float) angleX, 0.06f);
            laserEntity.lastLaserRotY = EndericLaserModel.lerp(laserEntity.lastLaserRotY, angleY, 0.06f);
