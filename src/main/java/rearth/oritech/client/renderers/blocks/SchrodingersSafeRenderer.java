...
public class SchrodingersSafeRenderer<R extends BlockEntityRenderState & GeoRenderState> extends MachineRenderer<SchrodingersSafeBlockEntity, R> {
    ...
    public SchrodingersSafeRenderer(BlockEntityRendererProvider.Context context, String modelPath) {
        super(context, modelPath);
        this.itemModelResolver = context.itemModelResolver();
    }

    @Override
    public void addRenderData(SchrodingersSafeBlockEntity animatable, @org.jspecify.annotations.Nullable Void relatedObject, R renderState, float partialTick) {
