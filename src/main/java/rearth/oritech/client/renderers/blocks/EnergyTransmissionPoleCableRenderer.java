...
public class EnergyTransmissionPoleCableRenderer implements BlockEntityRenderer<EnergyTransmissionPoleEntity, EnergyTransmissionPoleCableRenderer.CableRenderState> {
    ...
    public EnergyTransmissionPoleCableRenderer(BlockEntityRendererProvider.Context context) {
    }
    ...
    @Override
    public void extractRenderState(@NotNull EnergyTransmissionPoleEntity blockEntity, CableRenderState state, float partialTick, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
    ...
    @Override
    public AABB getRenderBoundingBox(EnergyTransmissionPoleEntity blockEntity) {
