...
public class AddonSplicerBlockRenderer<R extends BlockEntityRenderState & GeoRenderState> extends GeoBlockRenderer<AddonSplicerBlockEntity, R> {
    ...
    @Override
    public void addRenderData(AddonSplicerBlockEntity animatable, @Nullable Void relatedObject, R renderState, float partialTick) {
        super.addRenderData(animatable, relatedObject, renderState, partialTick);
        MachineRenderer.addColorRenderData(animatable, renderState);
    }

    private static class FullbrightFluidBoneLayer<R extends GeoRenderState> extends CustomBoneTextureGeoLayer<AddonSplicerBlockEntity, Void, R> {

        public FullbrightFluidBoneLayer(GeoRenderer<AddonSplicerBlockEntity, Void, R> renderer, String boneName) {
