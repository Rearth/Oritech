...
public class PortableTankRenderer implements BlockEntityRenderer<PortableTankEntity, PortableTankRenderer.TankRenderState> {

    public PortableTankRenderer(BlockEntityRendererProvider.Context context) {
    }
    ...
    @Override
    public void extractRenderState(PortableTankEntity entity, TankRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
