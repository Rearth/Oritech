...
public class ChargerBlockRenderer implements BlockEntityRenderer<ChargerBlockEntity, ChargerBlockRenderer.ChargerRenderState> {
    ...
    @Override
    public void extractRenderState(ChargerBlockEntity entity, ChargerRenderState state, float partialTicks, Vec3 cameraPosition, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress) {
    ...
    @Override
    public void submit(ChargerRenderState state, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState cameraRenderState) {
