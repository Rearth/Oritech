...
public class BlockTagGenerator extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        pickaxeBuilder.add(BlockContent.TAINTED_REFINERY_BLOCK);
        ...
        getOrCreateTagBuilder(TagContent.REFINERY_ARCANE_BLOCKS)
          ...
          .add(BlockContent.ARCANE_AUGMENT_STATION)
          .add(BlockContent.ENCHANTER_BLOCK)
          .add(BlockContent.ENCHANTMENT_CATALYST_BLOCK);
        
        getOrCreateTagBuilder(TagContent.REFINERY_SCULK_BLOCKS)
          .add(Blocks.SPAWNER)
          ...
          .add(Blocks.SCULK)
          .add(BlockContent.SPAWNER_CAGE_BLOCK)
          .add(BlockContent.SPAWNER_CONTROLLER_BLOCK);
