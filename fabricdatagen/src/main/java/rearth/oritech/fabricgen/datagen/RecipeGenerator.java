...
public class RecipeGenerator extends FabricRecipeProvider {
    ...
    private void addAugmentRecipes(RecipeExporter exporter) {
        ...
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 100, "hpboost");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.COPPER_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 200, "speedboost");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(TagContent.NICKEL_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "hpboostmore");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.DIAMOND_GEMS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 30, "dwarf");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "giant");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "autofeeder");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "armor");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "flight");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "cloak");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "portal");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "nightvision");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "waterbreath");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "magnet");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "orefinder");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "hpboostultra");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "hpboostultimate");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "superspeedboost");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "stepassist");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "betterarmor");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "ultimatearmor");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "weaponreach");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "blockreach");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "farblockreach");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "miningspeed");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "fastminingspeed");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "attackdamage");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "superattackdamage");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "luck");
        addAugmentRecipe(exporter, List.of(new SizedIngredient(2, of(ConventionalItemTags.IRON_INGOTS)), new SizedIngredient(1, of(ItemContent.ELECTRUM_INGOT))), List.of(new SizedIngredient(4, of(TagContent.COAL_DUSTS))), 10, "gravity");
    ...
    private void addAugmentRecipe(RecipeExporter exporter, List<SizedIngredient> inputs, List<SizedIngredient> applyCost, int time, String id) {
        var entry = new AugmentRecipe(RecipeContent.AUGMENT, inputs, applyCost, time);
