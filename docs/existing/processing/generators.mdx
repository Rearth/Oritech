...
The Large Solar Panel can generate between **32 RF/t** and **224 RF/t**, depending on the [machine cores](../processing/multiblocks) used. The model follows the sun automatically. It only
