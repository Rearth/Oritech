...
Fluid pipes behave similarly to item pipes. They connect to fluid containers, and can be set to extract by right-clicking a connection.
They also do not have an internal inventory.
