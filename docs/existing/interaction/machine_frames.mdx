...
The [block placer](../interaction/block_placer), [block destroyer](../interaction/block_destroyer), and [fertilizer](../interaction/fertilizer) all operate on a gantry built
with machine frames. The machine frame designates the area in which the machines operate. It must be rectangular and empty inside.
