...
the entire area in collectors ensures you'll catch them all. If all tachyons are collected, you can get up to 4x the amount of energy that was used to accelerate
the particles.

However for large collisions, a lot of high-energy tachyons will be emitted, which may cause collectors to reach their limit, and any excess energy will be waster.
Placing the collectors further back allows the tachyons to be spread over multiple collectors, so they don't fill up too quickly and get overwhelmed. At very high speeds (roughly above 10000)
even collectors further back will usually be overwhelmed, and the energy cannot be fully collected.
