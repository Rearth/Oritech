...
*   **Active Rod Count**: Indicates the amount of rods burning fuel (e.g. the actual number of rods per layer that are currently active. Double/Quad rods are counted as one.)
