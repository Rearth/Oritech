...
- Reactor heat vents take some heat from the hottest neighboring component, such as fuel rods or heat pipes, and vent it out of the reactor.
- Heat absorbers absorb a fixed amount of heat from all neighboring components but require a steady supply of coolant items to function.
...
resulting in a nuclear meltdown. If a rod reaches a temperature above 2000 C for a sustained amount of time, it will trigger a meltdown.
...
an interior height of 1 will also work similarly with an interior height of 10. However, the energy production as well as the coolant and fuel consumption
