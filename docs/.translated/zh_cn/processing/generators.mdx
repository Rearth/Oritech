...
大型太阳能电池板发电效率在 **32 RF/t** 和 **224 RF/t** 之间，其效率取决于搭建时使用的[机器核心](../processing/multiblocks)的等级。模型会自动向阳。仅在白天工作。
...
燃料发电机燃烧[原油](../resources/crude_oil)或涡轮燃料(Turbofuel)以产出电力，其拥有两个[插槽](../processing/addons)。初始状态下效率为 **256 RF/t**。
