...
生物质能发电机燃烧生物质以产出电力，其拥有两个[插槽](../processing/addons)。初始状态下效率为 **64 RF/t**。
...
大型太阳能电池板发电效率在 **32 RF/t** 和 **224 RF/t** 之间，其效率取决于搭建时使用的[机器核心](../processing/multiblocks)的等级。模型会自动跟着太阳。仅在白天工作。
